...
#' @format A data frame with 237 rows and 17 variables:
#' \describe{
...
#'   \item{\code{data_categories}}{character The categories of data collected in the project. Options are "Acoustic", "Bathymetry", "Chemical oceanography", "Crustaceans", "Forage fish", "Groundfish", "Habitat", "Highly migratory fish", "Marine mammals", "Molluscs", "Physical oceanography", "Plankton", "Protected fish", "Sea turtles", "Seabirds".}
